...
public class MediaFile {
	...
	// 根据视频MIME判断文件类型
	public static boolean isVideoFileTypeFromMime(String mimeType) {
		int fileType = getFileTypeForMimeType(mimeType);
		return isVideoFileType(fileType);
	}

	// 根据视频MIME判断文件类型
	public static boolean isImageFileTypeFromMime(String mimeType) {
		int fileType = getFileTypeForMimeType(mimeType);
		return isImageFileType(fileType);
	}

	// 根据视频MIME判断文件类型
	public static boolean isVideoFileTypeFromPath(String path) {
		MediaFileType type = getFileType(path);
		if (null != type) {
	...
	// 根据视频MIME判断文件类型
	public static boolean isImageFileTypeFromPath(String path) {
		MediaFileType type = getFileType(path);
		if (null != type) {
